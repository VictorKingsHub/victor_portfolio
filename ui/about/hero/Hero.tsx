        ...
        <div className={styles.text}>
          <div className={styles.namebody}>
            ...
            <h1 className={styles.name}>
              Hello, I&apos;m <span className={styles.nameEnd}>Victor Eze</span>
            </h1>
          </div>
          <div className={styles.about}>
            <p>
              I excel at crafting elegant digital experiences <br />
              I&apos;m hightly experienced in various frontend technologies
            </p>
          </div>
          <div className={styles.down}>
            ...
            <Link
              href='www.linkedin.com/in/eze-victor-nkemjika-hub'
              className={styles.Link}
            >
              <TiSocialLinkedin />
            </Link>
