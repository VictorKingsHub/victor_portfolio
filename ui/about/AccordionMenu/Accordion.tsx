        ...
        <div className={styles.left}>
          <div className={styles.edu}>
            ...
            <span>
              ...
              interfaces. Passionate about writing clean, efficient, responsive
              and maintainable code to provide solution to challanges
            </span>
          </div>
            ...
            {data.map((list: any) => {
              return (
                <div key={list.id}>
                  <div
                    className={` ${
                      selected === list.id ? styles.active : styles.question
                    } `}
